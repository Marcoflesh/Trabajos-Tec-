...
### system (s)
Esta se encarga para poder forzar la terminación del juego. Si el usuario decide no jugar y ya no volver a jugar al escoger la opción "no" la biblioteca forzará la terminación del juego mediante system.exit().
